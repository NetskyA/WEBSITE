...
!function (a, b) {
  ...
  n.event = {
    ...
    props: ("altKey bubbles cancelable ctrlKey currentTarget detail eventPhase metaKey rela" + "tedTarget shiftKey target timeStamp view which").split(" "),
    fixHooks: {},
    keyHooks: {
    ...
    mouseHooks: {
      props: ("button buttons clientX clientY offsetX offsetY pageX pageY screenX screenY toE" + "lement").split(" "),
      filter: function filter(a, b) {
        var c,
            e,
            f,
  ...
  !function () {
    ...
    if (h.style) {
      var _i = function _i() {
        h.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box" + ";position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;wid" + "th:50%", h.innerHTML = "", Ea.appendChild(g);
        var d = a.getComputedStyle(h);
        b = "1%" !== d.top, f = "2px" === d.marginLeft, c = "4px" === d.width, h.style.marginRight = "50%", e = "4px" === d.marginRight, Ea.removeChild(g);
      };

      h.style.backgroundClip = "content-box", h.cloneNode(!0).style.backgroundClip = "", l.clearCloneStyle = "content-box" === h.style.backgroundClip, g.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;positi" + "on:absolute", g.appendChild(h);
      n.extend(l, {
        ...
        reliableMarginRight: function reliableMarginRight() {
          ...
          return c.style.cssText = h.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;b" + "order:0;padding:0", c.style.marginRight = c.style.width = "0", h.style.width = "1px", Ea.appendChild(g), b = !parseFloat(a.getComputedStyle(c).marginRight), Ea.removeChild(g), h.removeChild(c), b;
        }
      });
    }
  }();
  ...
  }), n.each(("blur focus focusin focusout load resize scroll unload click dblclick mousedown" + " mouseup mousemove mouseover mouseout mouseenter mouseleave change select subm" + "it keydown keypress keyup error contextmenu").split(" "), function (a, b) {
    n.fn[b] = function (a, c) {
